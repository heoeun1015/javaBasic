...
/*		[4-5]
		...
		public class Exercise4_5 {
		 ...
		 //for문을 while로 바꿀 때는 초기화와 증감식만 따로 해주면 된다.
...
/*
		★ [4-9]
		숫자로 이루어진 문자열 이 있을 때 각 자리의 합을 더한 결과를 출력하는 코드를 완성하라.
		만일 문자열이 "12345"라면, ‘1+2+3+4+5’의 결과인 15가 출력이 출력되어야 한다.
		(1) 에 알맞은 코드를 넣으시오.
