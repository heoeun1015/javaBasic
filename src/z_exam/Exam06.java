		...
		*/
		...
		이유를 설명하시오.
			...
			class MemberCall {
				...
				static int cv = 20;
				int iv2 = cv;
				static int cv2 = iv; // 라인 A: static 변수에 instance 변수를 넣을 수 없다.
				static void staticMethod1() {
					System.out.println(cv);
					System.out.println(iv); // 라인 B: static 메서드에 instance 변수를 출력할 수 없다.
				}
				...
				static void staticMethod2() {
					staticMethod1();
					instanceMethod1(); // 라인 D: static 메서드에 instance 메서드를 넣을 수 없다.
				}
		...
		*/
		...
		[연습문제]/ch6/Exercise6_19.java
			class Exercise6_19
			{
				...
				str += "456"; //문자열이 변경되는 순간 주소가 바뀌어서, 위 str과는 값이 달라졌다. change랑은 그래서 달라짐.
				}
				public static void main(String[] args) //☆
				{
					String str = "ABC123";
					System.out.println(str);
					change(str); //☆참조형 타입이라 위랑 같다.
