...
/*		[2-1] 다음 표의 빈 칸에 개의 기본형(primitive type)을 알맞은 자리에 넣으시오.
		...
		[2-8] 참조형 변수 와 같은 크기의 기본형(primitive type)은? (a,d)
		a. int
		b. long
		c. short
		d. float
		...
		[2-10] char타입의 변수에 저장될 수 있는 정수 값의 범위는? (65535)
		...
		[2-12] 다음 중 main메서드의 선언부로 알맞은 것은? (a)
